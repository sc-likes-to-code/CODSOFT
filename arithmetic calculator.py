...
btn_11= tk.Button(root, text=".", command=lambda: add_to_calculation('.'), width=5, font= ("Arial", 14))
btn_11.grid(row=5, column=1)
btn_10= tk.Button(root, text="0", command=lambda: add_to_calculation(0), width=5, font= ("Arial", 14))
...
btn_del= tk.Button(root, text="DEL", command=del_field, width=5, font= ("Arial", 14))
